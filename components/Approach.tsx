  ...
  return (
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        <Card
          title="planning & stratedgy"
          icon={<AceternityIcon order="phase1" />}
          description="we'll colaborate to map out your websites goals target auidence and key functionalities.we'll discuss things like site structure, navigating,and content requirement"
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
